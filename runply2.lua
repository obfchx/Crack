...
Title.TextXAlignment = Enum.TextXAlignment.Left
                ...
                SliderButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)              SliderButton.BackgroundTransparency = 1.000
...
circlebar.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("Light Hub","BLOX FRUIT",Enum.KeyCode.RightControl);
-------------------------------------------------------------------------------------------------------
local I = Library:AddTab("T")
local Settings = Library:AddTab("N")
local Main = Library:AddTab("K")
local M = Library:AddTab("L")
local Ss = Library:AddTab("H")
local RaceV4 = Library:AddTab("B")
local EventGame = Library:AddTab("H")
local P = Library:AddTab("E")
local Status = Library:AddTab("O")
local Visual = Library:AddTab("Y")
local R = Library:AddTab("F")
local T = Library:AddTab("R")
local S = Library:AddTab("B")
local D = Library:AddTab("C")
local Misc = Library:AddTab("U")
--------------------------------------------------------------------------------------------------------

I:AddSeperator("Status Game")
Time = I:AddLabel("Executer Time")
...
Settings:AddToggle("Bypass TP",BypassTP,true,function(Fast)
BypassTP = Fast
end)
...
Settings:AddToggle("Auto Click",true,function(value)
_G.AutoClick = value
end)
...
Settings:AddToggle("Disabled Damage",true,function(Remo)
...
FarmMode = "Normal"
Main:AddDropdown("Select Farm Mode", ListF,function(value)
    FarmMode = value
end)
...
if World1 then
    Main:AddToggle("Auto Farm Fast (Farm Lv.1-300)",_G.AutoFarmFast,true,function(value)
        _G.Farmfast = value
...
Main:AddToggle("Auto Kaitun",true,function(value)
       _G.AutoFarm = value
...
Main:AddToggle("Auto Farm Chest Hop",_G.AutoFarmChest_Hop,function(value)
    ...
    Main:AddSeperator("Pirates Raid")
    
    Main:AddToggle("Auto Pirates Raid", _G.AutoCarvender,function(value)
     _G.RaidPirate = value
...
spawn(function()
    ...
    Main:AddSeperator("Misc Bone")
    
local ListB = {"NoQuest", "AcceptQuest", "MasteryFruit"}
BoneFMode = "AcceptQuest"
Main:AddDropdown("Select Bone Farm Mode", ListB,function(value)
    BoneFMode = value
end)
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    Main:AddToggle("Auto Pray",pry,function(value)
    _G.Pray = value
    end)
    ...
    Main:AddToggle("Auto Try Luck",Trylux,function(value)
    _G.Trylux = value
    end)
   ...
   Main:AddSeperator("Misc Mastery")
    ...
    Main:AddToggle("Auto Farm Sword Mastery",_G.AutoSwordMastery,function(value)
...
--------------------------------------------------------------------------------------------------------
    ...
    elseif World3 then
RaceV4:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    RaceV4:AddToggle("Auto Drive",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
...
RaceV4:AddButton("Teleport Advanced Fruit Dealer", function()
                TweenNpc()
                end)
...
spawn(function()
    ...
    M:AddToggle("Auto GodHuman",_G.Auto_God_Human,true,function(value)
...
--------------------------------------------------------------------------------------------------------
    EventGame:AddSeperator(" Sea Beast ")
 
    EventGame:AddToggle('Teleport to Seabaeat', false, function(value)
...
EventGame:AddToggle("Auto Sea Baest [Fully]",_G.Auto_Seabest,function(value)
...
EventGame:AddToggle("Destroy Boat if found SeaBeast or Player Health 0",_G.AutoDesBoat,function(value)
...
EventGame:AddToggle('Ennable Hop Sea Event Farm', false, function(value)
...
Visual:AddSeperator("Graphic")
    ...
    Visual:AddToggle("FPS Boost",true,function()
        pcall(function()
...
Visual:AddToggle("Remove Fog",RemoveFog,function(value)
    ...
    Visual:AddToggle("Infinite Ability",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Visual:AddToggle("Walk on Water",false,function(value)
        _G.WalkWater = value
    end)
...
S:AddButton("Buy Boat",function()
    ...
    S:AddButton("Buy Sanguine Art [ $5,000 Fragments $5,000,000 Beli ]",function()
...
--------------------------------------------------------------------------------------------------------
    ...
    D:AddButton("Random Fruit",true,function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    ...
    D:AddToggle("Auto Store Fruit",_G.AutoStoreFruit,true,function(value)
        _G.AutoStoreFruit = value
    end)
...
MainFrame.Size = UDim2.new(0, 480, 0, 255)
...
TextLabel.Text = "Kaitun Lunar Hub"
...
TextLabel1.Text = "Kaitun Lunar Hub"
...
BountyEarned.Text = "Ngủ Và Chờ Acc Max Cấp"
...
BountyEarned.Position = UDim2.new(0, 14, 0, 105)
...
TotalBountyEarned.Text = "Chúng Tôi Đem Lại Trải Nghiệm"
...
TotalBountyEarned.Position = UDim2.new(0, 14, 0, 140)
...
CilentTimeElapsed.Text = "Tốt Nhất Cho Người Dùng"
...
CilentTimeElapsed.Position = UDim2.new(0, 15, 0, 175)
