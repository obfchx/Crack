...
-------------------------------------------------------------------------------------------------------
local I = Library:AddTab("1")
local Settings = Library:AddTab("2")
local Main = Library:AddTab("3")
local M = Library:AddTab("4")
local Ss = Library:AddTab("5")
local RaceV4 = Library:AddTab("6")
local EventGame = Library:AddTab("7")
local P = Library:AddTab("8")
local Status = Library:AddTab("9")
local Visual = Library:AddTab("10")
local R = Library:AddTab("11")
local T = Library:AddTab("12")
local S = Library:AddTab("13")
local D = Library:AddTab("14")
local Misc = Library:AddTab("15")
--------------------------------------------------------------------------------------------------------
